...
Repo artifacts:
- Research notes: [research/summary.md](research/summary.md)
- OpenClaw plan: [specs/openclaw_integration.md](specs/openclaw_integration.md)
...
- [research/tooling_strategy.md](research/tooling_strategy.md)
...
- Vision & constraints: [specs/_meta.md](specs/_meta.md)
- Functional stories: [specs/functional.md](specs/functional.md)
- Technical contracts/schemas: [specs/technical.md](specs/technical.md)
- OpenClaw plan: [specs/openclaw_integration.md](specs/openclaw_integration.md)
...
|---|---|---|
| Persona DNA (SOUL.md) | Standard persona definition, hydrated into context | [SOUL.md](SOUL.md) (template); future: per-agent SOUL files |
| BoardKit governance | Fleet-wide policy propagation | [AGENTS.md](AGENTS.md) |
| FastRender swarm | Planner/Worker/Judge roles + quality gates | [research/architecture_strategy.md](research/architecture_strategy.md) |
| OCC consistency | Non-locking commit validation | [research/architecture_strategy.md](research/architecture_strategy.md) (OCC described) |
| MCP-only integrations | External world interactions through MCP | [CLAUDE.md](CLAUDE.md), [.cursor/rules](.cursor/rules), [specs/technical.md](specs/technical.md) |
| HITL governance | Confidence tiers + sensitive-topic routing | [research/architecture_strategy.md](research/architecture_strategy.md), [AGENTS.md](AGENTS.md) |
| Economic agency | Wallet actions guarded by policy (budget limits) | [specs/openclaw_integration.md](specs/openclaw_integration.md) (plan), [AGENTS.md](AGENTS.md) (controls) |
| TDD empty slots | Tests define the contract before implementation | [tests/test_trend_fetcher.py](tests/test_trend_fetcher.py), [tests/test_skills_interface.py](tests/test_skills_interface.py) |
| Governance pipeline | CI checks + review policy | [.github/workflows/main.yml](.github/workflows/main.yml), [.coderabbit.yaml](.coderabbit.yaml) |
...
- Stubs:
	- [skills/skill_download_youtube.py](skills/skill_download_youtube.py)
	- [skills/skill_transcribe_audio.py](skills/skill_transcribe_audio.py)
	- [skills/skill_trend_analyzer.py](skills/skill_trend_analyzer.py)
...
- Trend schema test: [tests/test_trend_fetcher.py](tests/test_trend_fetcher.py)
- Skills interface test: [tests/test_skills_interface.py](tests/test_skills_interface.py)
...
- Convert [REPORT_CHIMERA.md](REPORT_CHIMERA.md) to PDF/Doc and share a public link.

### Feb 6: Repo + Loom
Repo must include:
- `specs/`, `tests/`, `skills/`, [Dockerfile](Dockerfile), [Makefile](Makefile), [.github/workflows/main.yml](.github/workflows/main.yml), and rules files.
...
- [notebooklm_dump.md](notebooklm_dump.md)
